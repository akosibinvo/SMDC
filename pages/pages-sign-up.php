									...
									<form action="../php/signup.php" method="post" class="needs-validation" novalidate>
										...
										<div class="row">
											<div class="col-6 mt-xxl-0 w-auto h-auto">
												<div class="alert px-4 py-3 mb-0 bg-dark text-white rounded-4 shadow-lg position-absolute d-none" style="--bs-bg-opacity: .9; z-index: 1000;" role="alert" data-mdb-color="warning" id="password-alert">
