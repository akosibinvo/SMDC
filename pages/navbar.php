...
<body>
    ...
    <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-end">
            <a class="dropdown-item" href="<?php echo ($role === 'SA1' || $role === 'SA2' || $role == 'IMP') ? 'pages-profile.php' : 'pages-profile-imp.php'; ?>"><i class="align-middle me-1" data-feather="user"></i> Profile</a>
