...
<body>
										...
										<div class="card-body">
											...
											<div class="tab-content">
												...
												<div class="tab-pane fade" id="manage-password" role="tabpanel">
													<form action="../php/changePassword.php" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
															...
															<div class="col-sm-12 col-md-12 px-4">
																...
																<div class="row mb-4">
																	<div class="form-group mb-3">
																		...
																		<div class="input-group has-validation">
																			<input class="form-control border border-end-0" id="oldPasswordUser" type="password" name="profile-current-password" required>
																...
																<div class="row mb-3">
																	<div class="form-group">
																		...
																		<div class="input-group has-validation">
																			<input class="form-control border border-end-0" id="newPasswordUser" type="password" name="profile_new_password" required>
																...
																<div class="row mb-3">
																	<div class="form-group mb-3">
																		...
																		<div class="input-group has-validation">
																			<input class="form-control border border-end-0" id="confirmNewPasswordUser" type="password" name="profile_cpassword" required>
														...
														<div class="modal-footer">
															<div class="mt-3">
																<button id="updateUserPassword" type="submit" name="updateUserPassword" class="btn btn-primary">Save</button>
															</div>
														</div>
	...
	<script>
		(() => {
			...
			Array.from(forms).forEach(form => {
				...
				// Update validation classes as user types
				Array.from(form.elements).forEach(element => {
	...
	<script>
		...
		const newPasswordInput = document.getElementById('newPasswordUser');
		...
		const oldPasswordInput = document.getElementById('oldPasswordUser');
		...
		const confirmNewPasswordInput = document.getElementById('confirmNewPasswordUser');
	...
	<script>
		addEventListener("DOMContentLoaded", (event) => {
			const password = document.getElementById("newPasswordUser");
			const confirmPassword = document.getElementById("confirmNewPasswordUser");
			...
			password.addEventListener("input", () => {
				...
				if (isPasswordValid) {
					...
					$('#updateUserPassword').prop('disabled', true);
				}
			});
		});
	</script>
	...
	<script>
		$(document).ready(function() {
			...
			$('#confirmNewPasswordUser').on('keyup', function() {
				var password = $('#newPasswordUser').val();
				var confirmPassword = $(this).val();
				var errorMessageElement = $('#confirmNewPassError');

				if (password.length == 0) {
					$('#confirmNewPasswordUser').addClass('is-invalid').removeClass('is-valid');
					errorMessageElement.text('Please provide new password first');
				} else {
					if (confirmPassword.length > 0) {
						if (password === confirmPassword) {
							$('#confirmNewPasswordUser').removeClass('is-invalid').addClass('is-valid');
							errorMessageElement.text('');
							$('#updateUserPassword').prop('disabled', false);
						} else {
							$('#confirmNewPasswordUser').removeClass('is-valid').addClass('is-invalid');
