    ...
    $.fn.extend({
        passwordRequirements: function(options) {
            ...
            return this.each(function() {
				...
				// 	// Your code to execute when the password field changes
				// 	if (numCharactersDone === false || useLowercaseDone === false || useUppercaseDone === false || useNumbersDone === false || useSpecialDone === false) {
				// 		// $("password_signup").removeClass('is-valid').addClass('is-invalid');
				// 		$('#validationPass').text('');
				// 		$('#confirm_password_signup').prop('readonly', true);
				// 		//$('#submit_signup').prop('disabled', true);
				// 		showMessage();
				// 	}
				// 	else {
				// 		$('#confirm_password_signup').prop('readonly', false);
